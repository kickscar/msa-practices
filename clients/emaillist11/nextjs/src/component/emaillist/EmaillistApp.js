...
function EmaillistApp() {
    ...
    const addEmail = useAuthFetch(process.env.API_BASE_ENDPOINT, {method: 'post'});
    const fetchEmails = useAuthFetch(process.env.API_BASE_ENDPOINT);
    const logout = useAuthFetch('/logout', null, false);
    const deleteEmail = useAuthFetch(process.env.API_BASE_ENDPOINT, {method: 'delete'});
